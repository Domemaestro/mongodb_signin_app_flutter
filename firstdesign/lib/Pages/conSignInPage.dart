...
class conSignInPage extends StatefulWidget {
  const conSignInPage({super.key});

  @override
  State<conSignInPage> createState() => _conSignInPageState();
}

class _conSignInPageState extends State<conSignInPage> {
              ...
              children: [
                const Padding(
                  ...
                  child: Align(
                    ...
                    child: Text("Sign in \nto\nContinue",style: TextStyle(fontSize: 36,
